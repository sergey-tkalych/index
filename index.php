<?php
	...
	foreach($dirContent as $content){
		...
		if(is_dir($rootPath . $content)){
			$allProjectsContent .= '<li><a href="/' . $content . '" class="add-favorite' . $activeClass . '"></a><a href="/' . $content . '">' . $content . '</a></li>';
		}
	}
